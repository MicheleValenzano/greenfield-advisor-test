...
RABBITMQ_NOTIFICATIONS_QUEUE = os.getenv("RABBITMQ_NOTIFICATIONS_QUEUE", "sensor_data.notifications.queue")
RABBITMQ_ALERTS_QUEUE = os.getenv("RABBITMQ_ALERTS_QUEUE", "alerts.queue")
RABBITMQ_FIELD_ROUTING_KEY = os.getenv("RABBITMQ_FIELD_ROUTING_KEY", "field.*.device.*")
RABBITMQ_ALERTS_ROUTING_KEY = os.getenv("RABBITMQ_ALERTS_ROUTING_KEY", "alerts.*") # VERIFICARE
...
async def setup():
    ...
    alerts_queue = await channel.declare_queue(RABBITMQ_ALERTS_QUEUE, durable=True)
    ...
    await notifications_queue.bind(sensors_exchange, routing_key=RABBITMQ_FIELD_ROUTING_KEY)
    await alerts_queue.bind(alerts_exchange, routing_key=RABBITMQ_ALERTS_ROUTING_KEY)
